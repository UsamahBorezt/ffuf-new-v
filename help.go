...
func Usage() {
	...
	u_general := UsageSection{
		...
		Flags:         make([]UsageFlag, 0),
		Hidden:        false,
		ExpectedFlags: []string{"ac", "acc", "ack", "ach", "acs", "c", "config", "dedup", "dns-cache", "json", "maxtime", "maxtime-job", "noninteractive", "p", "rate", "resume", "retries", "scraperfile", "scrapers", "search", "s", "sa", "se", "sf", "t", "v", "V"},
	}
